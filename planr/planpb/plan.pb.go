...
func (x *Module) GetContacts() []string {
	if x != nil {
		return x.Contacts
	}
	return nil
...
type Process struct {
	...
	Interfaces    *ProcessInterfaces              `protobuf:"bytes,5,opt,name=interfaces,proto3" json:"interfaces,omitempty"`
	Datastores    map[string]*DatastoreConnection `protobuf:"bytes,6,rep,name=datastores,proto3" json:"datastores,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Process) GetContacts() []string {
	if x != nil {
		return x.Contacts
	}
	return nil
...
func (x *Process) GetVariants() []string {
	if x != nil {
		return x.Variants
	}
	return nil
...
func (x *Process) GetChanges() map[string]*Change {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *ConsumedInterface) GetProducers() []string {
	if x != nil {
		return x.Producers
	}
	return nil
...
const file_planpb_plan_proto_rawDesc = "" +
	...
	"\amodules\x18\x03 \x03(\v2\x11.migration.ModuleR\amodules\"\x8c\x01\n" +
	"\x06Module\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1a\n" +
	"\bcontacts\x18\x03 \x03(\tR\bcontacts\x120\n" +
	"\tprocesses\x18\x04 \x03(\v2\x12.migration.ProcessR\tprocesses\"\xe2\x03\n" +
	"\aProcess\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1a\n" +
	"\bcontacts\x18\x03 \x03(\tR\bcontacts\x12\x1a\n" +
	"\bvariants\x18\x04 \x03(\tR\bvariants\x12<\n" +
	"\n" +
	"interfaces\x18\x05 \x01(\v2\x1c.migration.ProcessInterfacesR\n" +
	"interfaces\x12B\n" +
	"\n" +
	"datastores\x18\x06 \x03(\v2\".migration.Process.DatastoresEntryR\n" +
	"datastores\x129\n" +
	"\achanges\x18\a \x03(\v2\x1f.migration.Process.ChangesEntryR\achanges\x1a]\n" +
	"\x0fDatastoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.migration.DatastoreConnectionR\x05value:\x028\x01\x1aM\n" +
	"\fChangesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.migration.ChangeR\x05value:\x028\x01\"h\n" +
	"\x06Change\x12\x12\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.migration.ProducedInterfaceR\x05value:\x028\x01\"1\n" +
	"\x11ConsumedInterface\x12\x1c\n" +
	"\tproducers\x18\x01 \x03(\tR\tproducers\"3\n" +
...
var file_planpb_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_planpb_plan_proto_goTypes = []any{
	...
	nil,                         // 15: migration.Process.ChangesEntry
	nil,                         // 16: migration.ProcessInterfaces.ConsumedEntry
	nil,                         // 17: migration.ProcessInterfaces.ProducedEntry
}
var file_planpb_plan_proto_depIdxs = []int32{
	...
	15, // 8: migration.Process.changes:type_name -> migration.Process.ChangesEntry
	16, // 9: migration.ProcessInterfaces.consumed:type_name -> migration.ProcessInterfaces.ConsumedEntry
	17, // 10: migration.ProcessInterfaces.produced:type_name -> migration.ProcessInterfaces.ProducedEntry
	...
	5,  // 14: migration.Process.ChangesEntry.value:type_name -> migration.Change
	7,  // 15: migration.ProcessInterfaces.ConsumedEntry.value:type_name -> migration.ConsumedInterface
	8,  // 16: migration.ProcessInterfaces.ProducedEntry.value:type_name -> migration.ProducedInterface
